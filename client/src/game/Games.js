     ...
     <div>
     	...
     	<h4>{this.props.user.name}</h4>
	     	<div className="influencerOption">
	      	...
	      	<div className="influencerOption">
		      <div className="influencerImg">
		          <img src="https://scontent-sea1-1.cdninstagram.com/vp/ddf8c9030040b733a82d2314bb86abcf/5B17BCF0/t51.2885-19/s320x320/24328051_136879256974724_970975059176849408_n.jpg" />
		        </div>
		        <div className="influencerContent">
		          <h5>Ariana Grande</h5>
		          <p className="increase">+.01%</p>
     	...
     	<h4>{this.props.user.name}</h4>
	     	...
	     	<div className="influencerOption">
		      <div className="influencerImg">
	      	  ...
	      	  <div className="influencerOption" id={this.props.id}>
		        <div className="influencerImg">
		          <img src="https://scontent-sea1-1.cdninstagram.com/vp/95e861255d8f8dc6daa9a1891009fdba/5B20704F/t51.2885-19/s320x320/20969376_112654676087652_1378856425261891584_a.jpg" />
		        </div>
		        <div className="influencerContent">
		          <h5>Taylor Swift</h5>
		          <p className="increase">+.03%</p>
		        </div>
	      	</div>
